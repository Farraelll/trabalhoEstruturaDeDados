...
// Funcao que processa as estatisticas e coloca no Time
...
// Funcao que retorna pontos ganhos
int time_get_pg(Time* time) {
    return (3 * time->v) + time->e;
}

// Funcao que retorna saldo de gols
int time_get_s(Time* time) {
    return time->gm - time->gs;
}

// Funcao que imprimi estatisticas
